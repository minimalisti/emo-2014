...
<html>
    ...
    <body>
        ...
        <div class="container">
            ...
            <p><span class="object">Kurssiolio</span> varmistaa ensin, ett‰ ilmoittautuminen on OK (kuten esimerkiss‰mme) ja lis‰‰ opiskelijan ilmoittautuneiden luetteloon, josta <span class="object">kurssiolio</span> itse pit‰‰ kirjaa.</p>
