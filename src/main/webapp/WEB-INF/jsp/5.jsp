...
<html>
    ...
    <body>
        ...
        <div class="container">
            ...
            <p><span class="object">Olioita</span> yhdistelem‰ll‰ voimme luoda 
                ohjelman aihepiiri‰ kuvaavan mallin. T‰ss‰ yksi pieni esimerkki 
                piirroksen muodossa:</p>

            <img src="/img/${materialType}/opiskelijaoliot-kurssit.png"/>

            <p><em><span class="object">Olioita</span>, jotka liittyv‰t 
                    kurssi-ilmoittautumisj‰rjestelm‰‰ et‰isesti muistuttavaan 
                    ...
                    <p>Kullakin <span class="object">oliolla</span> on oma 
                        ...
                        olla kirjanpito siit‰, keit‰ kurssille on ilmoittautunut, 
                        sek‰ uusista ilmoittautumisista huolehtiminen 
                        enimm‰isosallistujam‰‰r‰n puitteissa. Eri 
                        <span class="object">olioiden</span> toimintoja 
                        yhdistelem‰ll‰ saadaan aikaan koko ohjelman toiminta, 
                        mist‰ lis‰‰ hieman myˆhemmin.</p>
